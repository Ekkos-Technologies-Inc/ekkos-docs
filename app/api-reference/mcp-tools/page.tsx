    ...
    <DocsLayout>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4 text-white">29 MCP Tools</h1>
          <p className="text-xl text-[#7a7a8e] mb-6">
            ekkOS provides 29 MCP tools organized into 15 categories. Your AI calls these automatically — just ask naturally.
          </p>
