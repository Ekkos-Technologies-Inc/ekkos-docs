...
// Complete list of all 70+ MCP tools
const toolCategories = [
  {
    ...
    tools: [
      ...
      { name: 'ekkOS_Advisor', description: 'Get actionable recommendations from PROMETHEUS analysis for your patterns and workflow', required: false, params: ['action', 'period_days?', 'proposal_id?'] },
    ],
  },
  {
    ...
    tools: [
      ...
      { name: 'ekkOS_GraphQuery', description: 'Execute natural language queries against the Neo4j knowledge graph (Text2Cypher)', required: false, params: ['query'] },
      { name: 'ekkOS_Codebase', description: 'Hybrid codebase search: vector similarity + knowledge graph enrichment. Finds files by meaning and structural relationships (co-fixed files, system siblings).', required: false, params: ['query', 'limit?', 'file_types?'] },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'ekkOS_ApplicableDirectives', description: 'Retrieve context-aware directives relevant to your current project and scope', required: false, params: ['project', 'scope?', 'agent?'] },
  ...
  },
  {
    ...
    description: 'Generate images and fetch multimedia transcripts',
    color: 'orange',
    icon: Zap,
    tools: [
      { name: 'ekkOS_Imagine', description: 'Generate high-quality images using Nano Banana Pro (Gemini Image Generation)', required: false, params: ['prompt', 'size?', 'reference_image?'] },
      { name: 'ekkOS_YouTube', description: 'Fetch and save full transcripts from YouTube videos to your ekkOS library', required: false, params: ['videos'] },
      { name: 'ekkOS_YouTubeList', description: 'Search and list your saved YouTube transcripts', required: false, params: ['q?', 'limit?'] },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: Clock,
    tools: [
      { name: 'ekkOS_EvictPrepare', description: 'Prepare eviction — identify evictable blocks and get confirmation token', required: false, params: ['session_id', 'target_reduction?'] },
