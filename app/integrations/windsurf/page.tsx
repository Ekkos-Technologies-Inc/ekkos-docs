        ...
        <div className="mb-12">
          ...
          <div className="bg-teal-500/10 border border-teal-500/20 clip-lg p-6">
            ...
            <p className="text-[#e8e8f0]/90 text-sm mb-4">
              ekkOS integrates with Windsurf via the Model Context Protocol (MCP), giving the AI access to 29 memory tools that persist learnings across sessions.
            </p>
  ...
  "mcpServers": {
    "ekkos-memory": {
      ...
      "env": {
        ...
        {/* Available Tools */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-6 text-white">Available Tools (29 Total)</h2>
          ...
          <div className="mt-6 bg-teal-500/10 border border-teal-500/20 clip-lg p-6">
            <p className="text-[#e8e8f0]/90 text-sm">
              <strong className="text-white">34 tools total.</strong> View the complete reference at{' '}
        ...
        <section className="border-t border-[#1a1a2e] pt-12">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Link href="/tools" className="group bg-[#111118]/60 backdrop-blur-xl border border-[#1a1a2e] clip-lg p-6 hover:bg-[#111118]/60 hover:border-teal-500/30 transition-all">
              <h3 className="font-semibold text-white mb-2">Explore All 29 Tools</h3>
